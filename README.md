...
The custom desktop PC build below is primarily designed for gaming purposes while also offering strong performance for general-purpose activities, such as video editing, streaming, and even programming. Particularly, this is because the desktop build is considered and built with quality, updated, and high-end components, significantly composed of multi-core CPU, high-capacity RAM, and a dedicated graphics card, providing smooth frame rates and supporting general-purpose activities for its users. Additionally, this build is also considered and designed with a reliable battery, sufficient storage, and upgrade-friendly structure, offering suitability and sustainability for long-term, high-demand usage. 

The target budget for this build is Php 100,000 (+5%), which is considered an upper-range constraint as it is slightly higher than the average prices of computer builds. Given this sufficient budget allocation, the build has been ensured to offer and provide strong, reliable, and sustainable performance for demanding gaming and general-purpose activities and needs.
...
[https://pcpartpicker.com/list/kQFNt3](https://pcpartpicker.com/list/kQFNt3)

### Summary Table

| Component | Model | Price (USD/Php) | Notes |
|----|----|----|----|
| CPU | Intel Core i5-14600K 3.5Ghz Processor | $209.99 | Went with an i5 processor for a lower price. Has strong single-thread performance for gaming with high clock speeds. K-series chip meaning it also allows overclocking. It beats other 13th and 12th Intel processors delivering gaming performance close to an i7 chip but costs noticeably less. |
| CPU Cooler | Thermalright Peerless Assassin 120 SE 66.17 CFM CPU Cooler | $34.90 | Dual tower coolers provide better efficiency in heat dissipation than single tower counterparts. Good performance at a cheap price if you have no problem with fan noise. |
| Motherboard | Gigabyte Z790 AORUS ELITE X WIFI7 ATX LGA1700 Motherboard | $239.99 | Z-series high-end Intel chipset supporting full feature set (mainly overclocking, high power draw, modern connectivity). Offers high DDR5 bandwidth, low latency. |
| RAM | G.Skill Ripjaws S5 32 GB (2 x 16 GB) DDR5-6000 CL36 Memory | $109.99 | Hits the sweet spot in speed and size for the CPU & GPU with enough memory for gaming. Low-profile design with XMP support to easily get rated speeds and timings.  |
| Storage 1 | Kingston NV3 1 TB M.2-2280 PCIe 4.0 X4 NVME Solid State Drive | $63.99 | NVMe drive for high read/write speeds, reducing load times and system lag. Good value capacity for its price. |
| Storage 2 | Toshiba P300 2 TB 3.5" 7200 RPM Internal Hard Drive | $56.68 | Cost-effective bulk storage for lower priority games, media, or backups. |
| Graphics Card | Gigabyte GAMING OC GeForce RTX 5070 Ti 16 GB Video Card | $839.99 | The core of the build means it's also the most expensive. Strong 1440p performance and very capable in 4K even at demanding graphic settings (Ray Tracing + DLSS). 16 GB GDDR7 memory with high bandwidth helps in demanding textures, ray tracing, and performance in games.  |
| Power Supply | ASRock Steel Legend SL-850G 850 W 80+ Gold Certified Fully Modular ATX Power Supply | $99.99 | 850W PSU is fully capable of supporting the full load of the CPU boost + GPU. Fully modular design with better efficiency (80+ Gold). |
| Case | Phanteks XT PRO ATX Mid Tower Case | $67.98 | Cheap good-looking case chosen for its compatibility with all other parts. |
| Case Fans | Deepcool RF 120 56.5 CFM 120 mm Fans 3-Pack | $12.45 x 2 = $24.90 | Cheap pack of 3-pack RGB case fans with good airflow. Also compatible with the 10 x 120mm case fan layout of the case. |
| **Total** |  | **1,748.4 USD/101,651.10 Php** |  |
...
* **CPU Component**: Went with an i5 processor instead of an i7 or higher processor to reduce costs while still considering and providing strong and excellent multi-core performance for gaming and general-purpose activities.  
